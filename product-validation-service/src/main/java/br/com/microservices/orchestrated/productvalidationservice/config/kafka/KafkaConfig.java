...
public class KafkaConfig {
    ...
    @Value(value = "${spring.kafka.topic.orchestrator}")
    private String orchestratorTopic;

    @Value(value = "${spring.kafka.topic.product-validation-success}")
    private String productValidationSuccessTopic;

    @Value(value = "${spring.kafka.topic.product-validation-fail}")
